...
buyOn[i]: [i ~ n], if buy on day i, what's the best profit
sellOn[i]: [i ~ n], if sell on day i, what's the best profit.
equation:
buyOn: on day i, we can buy && sell in the future, or do nothing.
sellOn: on day i, we can sell && buy in the future, or do nothing.
